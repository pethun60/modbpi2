...
store = ModbusSlaveContext(
    ...
    hr=ModbusSequentialDataBlock(0, list(initial_float) * 50),  # Holding Registers as floats
...
async def update_holding_registers():
    ...
    while True:
        ...
        store.setValues(3, 0, list(registers) * 50)  # Update all holding registers with float
