...
parser.add_argument('-startreg', type=int, default=1, help='start modbus register ')
...
async def update_holding_registers():
    ...
    while True:
        ...
        store.setValues(3, args.startreg, list(registers) * 155)  # Update all holding registers with float
